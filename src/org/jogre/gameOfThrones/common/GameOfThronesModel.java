...
public class GameOfThronesModel extends JogreModel {
    ...
    */
    ...
    private void familiesConstruction(int playerNumber){
    	...
    	boardModel.getTerritory("Moat Cailin").setTroup(new GroundForce(families[0],1,1,1));
	...
	public void battleEnd(){
		battle=null;
		state=ModelState.PHASE_EXECUTION;
	...
	public void updateLabel(){
		...
		case BATTLE :
			...
			case Battle.BATTLE_SUPPORT_PHASE : 
				...
				text+="<br> attacker have an initial force of "+battle.attPower()+" defender have an initial force of "+battle.defPower()+"<br>";
				break;
